...
/*
 * This is an implementation of Binary Search Tree, which uses  as input
 *
 ...
 */
class Node<T extends Super & StringInterface<String> & IntegerInterface<Integer>> {
    T val;
...
public class SortedStorage<T extends Super & StringInterface<String> & IntegerInterface<Integer>> implements StorageInterface<T> {
    Node<T> root = null;
     ...
     * @return true/false  true if successfully deleted, else false
     */
    public boolean deleteRec(Node<T> node, T val) {
        if (node == null) {
            return false;
        }
        ...
        if (foundLeft) {
            ...
            // One child
                ...
                // Two children
                T temp = minValR(node.left.right);
                deleteRec(node, temp);
                node.left.val = temp;
                return true;
            }
            ...
            // One child
                ...
                // Two children
                T temp = minValR(node.right.right);
                deleteRec(node, temp);
                node.right.val = temp;
                return true;
            }
     ...
     */
    public boolean find(Node<T> node, T val) {
