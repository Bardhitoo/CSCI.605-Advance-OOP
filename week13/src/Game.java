...
public class Game {
    ...
    private Player.Picture[] pictures = new Player.Picture[numPlayer];
    private Player.GuessWord[] guessWords = new Player.GuessWord[numPlayer];
    ...
    protected Game(String[] args) {
        ...
        if (args.length != 12) {
            System.err.println("The Game.java needs to have six arguments!");
            System.err.println("java Game -me <meName> -meWord <meWord> -mePicture <mePicture> " +
                               "-you <youName> -youWord <youWord> -youPicture <youPicture>");
            System.exit(-1);
        }
        ...
        for (int index = 0; index < args.length; index += 2) {
            ...
            } else if (args[index].endsWith("-meWord")) {
                guessWords[0] = new Player.GuessWord(args[index + 1]);
            ...
            } else if (args[index].endsWith("-youWord")) {
                guessWords[1] = new Player.GuessWord(args[index + 1]);
